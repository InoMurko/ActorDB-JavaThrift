            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows = new ArrayList<Map<String,Val>>(_list3.size);
                Map<String,Val> _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  {
                    org.apache.thrift.protocol.TMap _map6 = iprot.readMapBegin();
                    _elem4 = new HashMap<String,Val>(2*_map6.size);
                    String _key7;
                    Val _val8;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReadResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (String _iter10 : struct.columns)
          {
      ...
      if (struct.rows != null) {
        oprot.writeFieldBegin(ROWS_FIELD_DESC);
        {
          ...
          for (Map<String,Val> _iter11 : struct.rows)
          {
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, _iter11.size()));
              for (Map.Entry<String, Val> _iter12 : _iter11.entrySet())
              {
  ...
  private static class ReadResultTupleScheme extends TupleScheme<ReadResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ReadResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeBool(struct.hasMore);
      {
        ...
        for (String _iter13 : struct.columns)
        {
      ...
      }
      {
        ...
        for (Map<String,Val> _iter14 : struct.rows)
        {
          {
            oprot.writeI32(_iter14.size());
            for (Map.Entry<String, Val> _iter15 : _iter14.entrySet())
            {
