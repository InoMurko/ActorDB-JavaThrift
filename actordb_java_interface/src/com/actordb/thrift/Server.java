...
public class Server implements org.apache.thrift.TBase<Server, Server._Fields>, java.io.Serializable, Cloneable, Comparable<Server> {
  ...
  public List<String> servers; // required
  public List<Group> groups; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.GROUPS, new org.apache.thrift.meta_data.FieldMetaData("groups", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "Group"))));
  ...
  public Server(Server other) {
    if (other.isSetServers()) {
      List<String> __this__servers = new ArrayList<String>(other.servers);
      this.servers = __this__servers;
    }
    if (other.isSetGroups()) {
      List<Group> __this__groups = new ArrayList<Group>(other.groups.size());
  ...
  public java.util.Iterator<String> getServersIterator() {
    return (this.servers == null) ? null : this.servers.iterator();
  }

  public void addToServers(String elem) {
  ...
  public Server setServers(List<String> servers) {
    this.servers = servers;
    return this;
  }
  ...
  public Server setGroups(List<Group> groups) {
    this.groups = groups;
    return this;
  }
  ...
  private static class ServerStandardScheme extends StandardScheme<Server> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.servers = new ArrayList<String>(_list0.size);
                String _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readString();
                  struct.servers.add(_elem1);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.groups = new ArrayList<Group>(_list3.size);
                Group _elem4;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Server struct) throws org.apache.thrift.TException {
      ...
      if (struct.servers != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.servers.size()));
          for (String _iter6 : struct.servers)
          {
      ...
      if (struct.groups != null) {
        oprot.writeFieldBegin(GROUPS_FIELD_DESC);
        {
          ...
          for (Group _iter7 : struct.groups)
          {
            _iter7.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ServerTupleScheme extends TupleScheme<Server> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Server struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (String _iter8 : struct.servers)
        {
      ...
      }
      {
        ...
        for (Group _iter9 : struct.groups)
        {
          _iter9.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Server struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.servers = new ArrayList<String>(_list10.size);
        String _elem11;
        for (int _i12 = 0; _i12 < _list10.size; ++_i12)
        {
          _elem11 = iprot.readString();
          struct.servers.add(_elem11);
        }
      }
      struct.setServersIsSet(true);
      {
        org.apache.thrift.protocol.TList _list13 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.groups = new ArrayList<Group>(_list13.size);
        Group _elem14;
